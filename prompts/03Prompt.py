...
# in the input variable we have to pass exactly those variable which are we using in our prompt if we use -
# less or more number of variables then we are going to get the error
